...
itn = subs(it,[R L Vi],[10 0.1 100]); hl1 = ezplot(itn,[0,0.05]);
itn = subs(it,[R L Vi],[50 0.1 100]); hl2 = ezplot(itn,[0,0.05]);
itn = subs(it,[R L Vi],[100 0.1 100]); hl3 = ezplot(itn,[0,0.05]);
...
vtn = subs(vt,[R L Vi],[10 0.1 100]); hl1 = ezplot(vtn,[0,0.05]);
vtn = subs(vt,[R L Vi],[50 0.1 100]); hl2 = ezplot(vtn,[0,0.05]);
vtn = subs(vt,[R L Vi],[100 0.1 100]); hl3 = ezplot(vtn,[0,0.05]);
